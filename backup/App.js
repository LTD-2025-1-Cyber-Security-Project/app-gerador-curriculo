...
const ConfiguracoesAvancadasScreen = ({ navigation }) => {
  ...
  const carregarDadosDeUso = async () => {
    try {
      // Em um app real, isso viria do AsyncStorage
      // Simulando dados de uso para demonstração
      const mockUsageData = {
        totalCalls: 123,
        totalTokens: 42560,
        byIA: {
        ...
        history: [
          { date: '2025-05-15', ia: 'GEMINI', type: 'Análise de currículos', tokens: 1200, prompt: 'Analisar currículo para vaga de dev' },
          { date: '2025-05-14', ia: 'CLAUDE', type: 'Busca de vagas', tokens: 800, prompt: 'Encontrar vagas de UX/UI' },
          { date: '2025-05-14', ia: 'GEMINI', type: 'Análise de currículos', tokens: 1350, prompt: 'Avaliar perfil para vaga senior' },
          { date: '2025-05-13', ia: 'PERPLEXITY', type: 'Geração de textos', tokens: 550, prompt: 'Criar descrição de vaga' },
          { date: '2025-05-12', ia: 'GEMINI', type: 'Busca de vagas', tokens: 920, prompt: 'Buscar vagas remotas' },
          { date: '2025-05-11', ia: 'CLAUDE', type: 'Outros', tokens: 420, prompt: 'Dicas para entrevista' },
          { date: '2025-05-10', ia: 'PERPLEXITY', type: 'Análise de currículos', tokens: 1100, prompt: 'Comparar perfis' },
          { date: '2025-05-09', ia: 'GEMINI', type: 'Geração de textos', tokens: 780, prompt: 'Email de feedback' },
          { date: '2025-05-08', ia: 'CLAUDE', type: 'Busca de vagas', tokens: 650, prompt: 'Vagas para iniciantes' },
          { date: '2025-05-07', ia: 'GEMINI', type: 'Análise de currículos', tokens: 1230, prompt: 'Avaliar competências técnicas' },
          { date: '2025-05-06', ia: 'PERPLEXITY', type: 'Outros', tokens: 480, prompt: 'Sugestões de portfólio' },
          { date: '2025-05-05', ia: 'CLAUDE', type: 'Geração de textos', tokens: 870, prompt: 'Carta de apresentação' },
          { date: '2025-05-04', ia: 'GEMINI', type: 'Busca de vagas', tokens: 680, prompt: 'Vagas em São Paulo' },
          { date: '2025-05-03', ia: 'PERPLEXITY', type: 'Análise de currículos', tokens: 1190, prompt: 'Verificar experiência' },
          { date: '2025-05-02', ia: 'GEMINI', type: 'Geração de textos', tokens: 740, prompt: 'Descrição para LinkedIn' }
        ]
      };
      
      // Em um app real:
      // const usageDataStr = await AsyncStorage.getItem('ia_usage_data');
      // const mockUsageData = usageDataStr ? JSON.parse(usageDataStr) : defaultData;
